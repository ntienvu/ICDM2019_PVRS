...
for index in range(0,NN):
    ...
    if myfunction.ismax==1:
        ...
        print("recommemded x={} current inferred value y={:.4f}, best inferred value={:.4f}".format(bo.X_original[-1],myfunction.ismax*bo.Y_original_maxGP[-1],myfunction.ismax*bo.Y_original_maxGP.max()))
    sys.stdout.flush()
